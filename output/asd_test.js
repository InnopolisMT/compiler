...
const functions = [
  {name: 'test', params: [{name: 'a', type: 'integer'}, {name: 'b', type: 'integer'}], returnType: 'real'},
  {name: 'main', params: [], returnType: null}
];

async function loadWasm() {
    try {
        const wasmPath = path.join(__dirname, 'asd.wasm');
...
function printHelp() {
    console.log('Usage: node asd_test.js <function_name> [args...]');
    console.log('');
    ...
    console.log('  node asd_test.js main');
    console.log('  node asd_test.js test 10 5');
}
